...
const Community = () => {
  ...
  return (
    <div className='p-6 pt-12 xl:px-20 w-full mx-auto h-full overflow-y-scroll'>
      ...
      dark:text-purple-100'>Community Images</h1>

      {images.length > 0 ? (
        <div className='flex flex-wrap max-sm:justify-center gap-5'>
            {images.map((item,index)=>(
              <a key={index} href={item.imageUrl} target='_blank' className='relative group block
              rounded-lg overflow-hidden border border-gray-200 dark:border-y-purple-700
