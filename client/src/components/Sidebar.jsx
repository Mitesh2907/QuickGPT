...
const Sidebar = ({ isMenuOpen, setIsMenuOpen }) => {
  ...
  // ⭐ navigate React Router se ayega, AppContext se nahi
  const navigate = useNavigate();

  // ⭐ navigate ko yaha se hata diya
  const {
    chats,
    setSelectedChat,
    selectedChat,
  ...
  return (
    <div
      className={`flex flex-col h-screen min-w-72 p-2 dark:bg-linear-to-b from-[#242124]/30
      to-[#000000]/30 border-r border-[#80609F]/30 backdrop:blur-3xl transition-all
